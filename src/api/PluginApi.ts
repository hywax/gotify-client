import type { HttpClient, PluginConf } from '../types'
...
export class PluginApi {
   ...
   */
  public getPluginConfig(id: number): Promise<object> {
   ...
   */
  public updatePluginConfig(id: number): Promise<void> {
   ...
   * Disable a plugin.
   */
  public disablePlugin(id: number): Promise<void> {
   ...
   */
  public getPluginDisplay(id: number): Promise<string> {
   ...
   * Enable a plugin.
   */
  public enablePlugin(id: number): Promise<void> {
